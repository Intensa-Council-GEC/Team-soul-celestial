...
if (isset($_POST['submit'])) {
    ...
    if (mysqli_num_rows($result) > 0) {
        ...
        $check_email = mysqli_query($conn, "SELECT email FROM patient where email = '" . $_POST['email'] . "' ");
        ...
        } elseif (mysqli_num_rows($check_email) > 0) //check email
        {
            ...
            $insert = "INSERT INTO `patient` (`username`, `email`, `password`) VALUES ('$username', '$email', '$password')";
