...
if (isset($_POST['submit'])) {
    ...
    if ($password == "" || $password == null) {
        $sql = "UPDATE `patient` SET `email`='$email' WHERE username='$_SESSION[username]'";
        ...
        $sql = "UPDATE `patient` SET `username`='$username',`password`='$password' WHERE email='$_SESSION[email]'";
        $result = mysqli_query($conn, $sql);
        if (!$result) {
            $error = "Failed to update into the database.";
        } else {
            ...
            <div class="mainss">Update Page</div>
                ...
                <form method="POST" enctype="multipart/form-data">
                    <div class="box">
                        ...
                        <?php
                        $sql = "select * from patient where username='$_SESSION[username]' limit 1";
                        $result = mysqli_query($conn, $sql);
