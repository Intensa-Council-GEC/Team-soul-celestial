                ...
                <div classs='hhh'>
                    <table>
                        ...
                        <tbody>
                            ...
                            $sql = "select * from prescription where endd>='$d' and dname='$ppp'";
                            ...
                            $qlimit = "select * from prescription where refill='1' and dname='$ppp'";
                            ...
                            while ($row = $result_limit->fetch_assoc()) {
                                echo "
                                     ...
                                     <td>$row[endd]</td>
                                     <td>
                                     <a href='./requestpres.php?pid=$row[pid]'>Approve Refill Request</a>
                                     </td>
                                    </tr>
                                        ";
                            }
