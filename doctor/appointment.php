...
if (isset($_POST['submit'])) {
	if (empty($_POST['pname'])) {
		$errors = "You must fill in the patient name";
	} else {
...
<body style="min-height: 80vh;">
	...
	<div class="content" style="display:grid;place-items:center;margin:7rem;border-radius:0.5rem;">
		<table class="tt table-hover" table-border="1" cellspacing="0" style="border-radius:0.5rem;">
			<div style="font-size:1.1rem;color:white;font-weight:700;" class="appst">Appointment Schedule</div>
			<tr>
				<th width="15%" style="font-size:1.1rem;text-align:center; color:white; background:#8a2ce2;">Appointment ID</th>
				<th width="15%" style="font-size:1.1rem;text-align:center; color:white; background:#8a2ce2;">Appointment Date</th>
				<th width="15%" style="font-size:1.1rem;text-align:center; color:white; background:#8a2ce2;">Appointment Time</th>
				<th width="15%" style="font-size:1.1rem;text-align:center; color:white; background:#8a2ce2;">Patient Name</th>
			</tr>
			<?php
			...
			?>
				<tr>
					...
					<td style="font-size:1.1rem;text-align:center;"><?php echo $patname ?></td>
				</tr>
			<?php
			}
			?>
		...
		<table class="table1" style="width:80vw;border-radius:0.5rem;">
			<thead>
				<tr>
					<th scope='col' style="padding:0 3rem;">Patient Name</th>
			...
			<form method="post" action="appointment.php" class="input_form">
				...
				<?php   }     ?>
				<tr>
					<td><input type="text" name="pname" class="appt_input"></td>
